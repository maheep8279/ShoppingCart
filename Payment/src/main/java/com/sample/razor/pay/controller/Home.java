...
/**
 * 
 * @author rahul This can only be used for payment for order in RazorPay.
 */
@Controller
public class Home {
	 ...
	 */
	private static final String SECRET_ID = "rzp_test_ML7RAdbCNYGpPL";
	private static final String SECRET_KEY = "ezcitaTS7fwRen8XxmQowi6C";
